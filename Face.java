...
public class Face{
	...
	public Point barycentre() {
		...
		float[] bary={0,0,0};// Initialisation des coordonnees du barycentre
		
		// On veut faire la moyenne des coordonnees de tous les sommets de la face
		
		// On additionne d'abord les coordonnees des sommets
		// lA correspond e la liste d'aretes de la face (this). 
