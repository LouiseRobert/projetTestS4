...
public class Affichage extends Application { 
	...
	public void start(Stage stage) {
		...
		MenuItem tetraItem = new MenuItem("Tetraedre");
		MenuItem cubeItem = new MenuItem("Cube");
		MenuItem octaItem = new MenuItem("Octaedre");
		MenuItem icoItem = new MenuItem("Icosaedre");
		MenuItem dodeItem = new MenuItem("Dodecaedre");
...
//		boutonDodecaedre.setLayoutY(100); 
		...
		Group root = new Group(menuBar, mesh, boutonDual);
	

		//Duree de la rotation
		...
		//L'animation ne se refait pas a l'envers
		rotateTransition.setAutoReverse(false);  




		// Creation de l'objet qui va reagir en cas d'evenement, c'est a dire
		...
		EventHandler<ActionEvent> eventBoutonTetra = new EventHandler<ActionEvent>() { 
			...
			// A la creation de l'objet, on redefinit la fonction handle. Celle-ci est propre
			// a cet EventHandler, et est redefinie pour chaque EventHandler cree. 
			// Quand l'evenement est declenche, la fonction handle est executee.		
			public void handle(ActionEvent event) { 
				
				// Ici, cet EventHandler est en association avec le bouton Tetraedre.
				// Il a pour but de faire apparaitre uniquement le tetraedre a l'ecran.
				...
				// On cree notre solide, ici le tetraedre. On note que c'est encore un objet
				// de classe Solide, il n'est pas affichable en l'etat.
				...
				// On ajoute le MeshView au groupe qui va l'afficher a l'ecran.
				mesh.getChildren().add(tetraedre);
				solideAffiche = tetra;
				
				// On gere l'animation pour que le tetraedre tourne. On la stoppe pour changer
				// d'objet a animer. Une fois que l'on indique que le Node cible est le tetraedre, 
				// on peut demarrer l'animation.
				rotateTransition.stop();
				rotateTransition.setNode(tetraedre);
				rotateTransition.play(); 
			}           
		};   
		//On ajoute pour finir l'evenement au bouton concerne, en precisant qu'il s'agit d'un clic de souris
...
//		//Creation du groupe contenant les objets
		...
		//Creation de la scene avec notre groupe d'objets
	...
	//       
	////Creation de l'animation de rotation  
	//            
